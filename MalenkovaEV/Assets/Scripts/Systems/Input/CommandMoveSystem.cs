...
public class CommandMoveSystem : ReactiveSystem<InputEntity>
{
    ...
    {
        return context.CreateCollector(InputMatcher.AllOf(InputMatcher.LeftArrow, InputMatcher.RightArrow, InputMatcher.ArrowDown));
    }
    ...
    protected override void Execute(List<InputEntity> entities)
    {
        foreach (InputEntity e in entities)
        {
            ...
            Vector2 newPosition = mover.position.value + e.arrowDown.direction;
            mover.ReplacePosition(newPosition);
        }
    }
}